...
var localeSearchString=contextRoot;

//check to see if a cookie exists with WSsamplesBrowserLocale
var cookieName='WSsamplesBrowserLocale';
if (document.cookie!=null){
	...
	for (var i=0;i<cookieItems.length;i++){
		...
		if (item.indexOf(cookieName)==0){
			//found the cookie, so set the localeSearchString
			localeSearchString="/"+item.substring(cookieName.length+1,item.length)+"/";
		}
	}
}

//determine what Language
if (localeSearchString.search("/zh_CN/") != -1) {
    browserLocale = "zh_CN";        
    browserLocaleM = 1.33;
}

else if (localeSearchString.search("/zh_TW/") != -1) {
        browserLocale = "zh_TW";        
        browserLocaleM = 1.33;
}

else if (localeSearchString.search("/fr/") != -1) {
        browserLocale = "fr";        
        browserLocaleM = 1.0;
}

else if (localeSearchString.search("/de/") != -1) {
        browserLocale = "de";        
        browserLocaleM = 1.0;
}

else if (localeSearchString.search("/en/") != -1) {
        browserLocale = "en";        
        browserLocaleM = 1.0;
}

else if (localeSearchString.search("/it/") != -1) {
        browserLocale = "it";        
        browserLocaleM = 1.0;
}
		
else if (localeSearchString.search("/ja/") != -1) {
        browserLocale = "ja";        
        browserLocaleM = 1.1;
}

else if (localeSearchString.search("/ko/") != -1) {
        browserLocale = "ko";        
        browserLocaleM = 1.1;
}

else if (localeSearchString.search("/pt_BR/") != -1) {
        browserLocale = "pt_BR";        
        browserLocaleM = 1.0;  
}

else if (localeSearchString.search("/es/") != -1) {
        browserLocale = "es";        
        browserLocaleM = 1.0;  
}

else if (localeSearchString.search("/hu/") != -1) {
        browserLocale = "hu";        
        browserLocaleM = 1.0;  
}

else if (localeSearchString.search("/cs/") != -1) {
        browserLocale = "cs";        
        browserLocaleM = 1.0;  
}

else if (localeSearchString.search("/pl/") != -1) {
        browserLocale = "pl";        
        browserLocaleM = 1.0;  
}

else if (localeSearchString.search("/ru/") != -1) {
        browserLocale = "ru";        
        browserLocaleM = 1.0;  
}
...
//Korean Charcter Sets

if (browserLocale == "ko") {
document.write("TD	{ font-size: " + 8.5*multiplier + "pt; font-family: Verdana, Helvetica, sans-serif; line-height: 1.2em; }");
}
...
if (browserLocale == "ko") {
document.write("TABLE.sampnav { margin-top: 0; margin-left: 0; margin: 0; padding-top: 4px; padding-bottom: 4px; }");
}
...
if (browserLocale == "zh_cn" || browserLocale == "zh_tw" || browserLocale == "ja" || browserLocale == "ko") {
   ...
   document.write("TABLE.sampnav { padding: 2; }");
