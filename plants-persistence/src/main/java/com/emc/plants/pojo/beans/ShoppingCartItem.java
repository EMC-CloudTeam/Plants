 ...
 */
// TODO: turn this into a MappedSuperclass subclass :-)
...
// TODO: lowp: consolidate ShoppingCartItem and Inventory
   private String id;
   private String name;
    ...
    */
   public ShoppingCartItem(String id, String name, String pkginfo,
    ...
    */
   public ShoppingCartItem(String id, String name, String heading, 
   ...
   public ShoppingCartItem(Inventory inv)
   {
      ...
      this.quantity = 1;				// default orderable quantity
