...
<title>Plants by WebSphere Administration</title>
...
<body  marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" onload="top">
<table bgcolor="#ffffff" cellpadding="4" cellspacing="0" border="0" width="100%">
<tr>
   <td width="100%">
      <A href="/plants-web/admin?admintype=backorder&action=getbackorders">Manage BackOrders</A> - View backorder inventory, order from suppliers, add new stock to inventory.
   </td>
...
<tr>
   <td><A
			href="/plants-web/admin?admintype=supplierconfig">Supplier Configuration</A> - Configure the Supplier.</td>
</tr>
<tr>
   <td></td>
</tr>
  ...
  <tr>
    ...
    <td>
      <p class="footer">
                  ...
                  <a class="footer" href="admin.html" target="_top">Admin Home</a>&nbsp;&nbsp;:&nbsp;
