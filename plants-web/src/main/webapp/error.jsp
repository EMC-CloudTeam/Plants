...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td bgcolor="ffffff" width="10"><img border="0" src="/plants-web/images/1x1_trans.gif" width="10" height="1" alt=""></td>
    <td bgcolor="ffffff" width="100%"><img border="0" src="/plants-web/images/pbw.jpg" width="181" height="48" alt="Plants by WebSphere"></td>
  </tr>
</table>
</body>
</html>
