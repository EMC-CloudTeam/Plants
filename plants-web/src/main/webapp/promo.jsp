...
<body marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" onload="top.deselectMenu('menu1');top.deselectMenu('menu2');top.deselectMenu('menu3');top.deselectMenu('menu4')">
<table bgcolor="#669966" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td width="100%">
        <table bgcolor="#395639" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="100%" valign="top" align="center" nowrap><img src="/plants-web/images/theme_summer_text.gif" width="209" height="198" border="0" alt="Gardens of Summer: They all start with the right colors, and we've got them all."></td>
          <td valign="top" align="left" rowspan="2" nowrap><img src="/plants-web/images/theme_summer1.gif" width="548" height="277" border="0" alt="Image of a colorful garden"></td>
        </tr>
        <tr>
          <td valign="top" align="right" nowrap><img src="/plants-web/images/theme_summer2.gif" width="208" height="79" border="0" alt="Gardens of Summer: They all start with the right colors, and we've got them all."></td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    <td class="space" bgcolor="#ffffff" width="100%"><img border="0" src="/plants-web/images/1x1_trans.gif" width="1" height="1" alt=""></td>
  </tr>
  ...
  <tr>
    <td width="100%">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td valign="top" width="30%" bgcolor="#DCEBCD">
            <table width="100%" border="0" cellpadding="4" cellspacing="0">
              <tr>
                <th class="promos" align="left" bgcolor="#669966">Tips</th>
              </tr>
              <tr>
                <td bgcolor="#DCEBCD"><p class="tips">Preserve extra grass seed by keeping it dry.
                Tape boxes and bags closed, or seal them into plastic bags. Be sure to remove extra air
                from the bags. Store all seed in a cool, dry area such as a garage or basement.</td>
              </tr>
            </table>
          </td>
          <td class="space" valign="top" bgcolor="#ffffff"><img border="0" src="/plants-web/images/1x1_trans.gif" width="1" height="20" alt=""></td>
          <td valign="top" bgcolor="#DCEBCD" width="70%">
            <table width="100%" border="0" cellpadding="4" cellspacing="0">
              <tr>
